...
*Консольное приложение по простому анализу текста. В первое очередь было разработано для практики написания автоматизированных тестов*
- Топ слов, общее количество слов, количество и процент уникальных слов
- Техники проектирования тестов: BVA, ECP, Branch Coverage, Statement Coverage
- **Стек:** С#, xUnit, Stryker.NET
